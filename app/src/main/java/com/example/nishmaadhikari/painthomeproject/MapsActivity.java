...
import com.example.nishmaadhikari.painthomeproject.R;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(new LatLng(27.670169,85.3376763)).title("Balkumari, Patan").snippet("Asian Paints Nepal"));
        mMap.addMarker(new MarkerOptions().position(new LatLng(27.1164902,85.3536415)).title("Chandranigahapur-Gaur Road, Chandrapur").snippet("Asian Paints Nepal"));
        mMap.addMarker(new MarkerOptions().position(new LatLng(26.953367,85.3161053)).title("Chandranigahapur-Gaur Road, Garuda").snippet("EVEREST BANK ATM"));
